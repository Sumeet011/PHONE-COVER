...
const newRepetitions = Math.ceil(containerWidth / textWidth) + 2 || 4;

      setRepetitions(newRepetitions);
    }
  };

  requestAnimationFrame(calculateRepetitions); // <-- add this
  ...
  ref={containerRef}
  style={{ minHeight: '2rem' }} // ensure visible area
>
